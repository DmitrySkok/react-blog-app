          ...
          <Col key={post.id}>
            <Card>
              <Card.Body>
                ...
                <Card.Text className="mb-2">
                  <b>Published: </b><span className="text-muted">{dateToStr(post.publishedDate)}</span>
                </Card.Text>
                <Card.Text className="mb-2">
                  <b>Category: </b><span className="text-muted">{post.category ? post.category : 'not selected'}</span>
                </Card.Text>
                <Card.Text>
